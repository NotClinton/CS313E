...
class Keyboard:
    ...
    def update(self, feedback_colors, guessed_word):
        ...
        for i, _ in enumerate(guessed_word):
    ...
    def __str__(self):
        ...
        for letter in self.rows[0]:
            colors1.append(self.colors[letter])
        first += color_word(colors1, self.rows[0])

        second = " "
        colors2 = []
        for letter in self.rows[1]:
            colors2.append(self.colors[letter])
        second += color_word(colors2, self.rows[1])

        third = "   "
        colors3 = []
        for letter in self.rows[2]:
            colors3.append(self.colors[letter])
        third += color_word(colors3, self.rows[2])
